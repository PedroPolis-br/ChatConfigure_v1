const messages = {
  pt: {
    translations: {
      ...
      showTicketOpenModal: {
        title: "Ticket já está em atendimento",
        warning: "Este contato já possui um ticket aberto!",
        currentUser: "Atendente atual",
        currentQueue: "Fila atual",
        instruction: "Entre em contato com o atendente responsável ou aguarde o ticket ser liberado.",
        button: {
          ok: "Entendi"
        }
      },
